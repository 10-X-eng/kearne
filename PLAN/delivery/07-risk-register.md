...
| RISK-008 | One-file storage has latency/corruption/large-artifact limits | Medium / Critical | WAL/copy contention, huge DB amplification | SQLite fault/performance prototype, external derived cache | change physical storage before public format; logical ports remain |
