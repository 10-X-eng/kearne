...
inline sketch::Definition completeDefinition(std::uint64_t seed = 1) {
  ...
  result.entities = {
      ...
      sketch::ParabolicArcEntity{parabolicArcId,
                                 ...
                                 length(0.021 + offset),
                                 seed % 2U == 0},
      sketch::BSplineEntity{bsplineId,
                            ...
                            {dimensionless(0.0), dimensionless(0.0),
                             ...
                             dimensionless(1.0), dimensionless(1.0)},
                            {dimensionless(1.0), dimensionless(0.75),
                             dimensionless(1.25), dimensionless(1.0)},
                            3U,
                            false,
                            seed % 2U != 0},
  ...
  result.objects = {
      ...
      sketch::SketchObject{
          id<SketchObjectId>(seed + 1'016),
          "Imported guides (modified)",
          sketch::SketchObjectKind::CurveGroup,
          {{"guide", secondLine}, {"clearance", secondCircle}}},
  };
  ...
  result.constraints = {
      ...
      sketch::Horizontal{constraintId(2),
                         firstLine,
                         {std::string{"Datum horizontal"},
      ...
      sketch::Distance{constraintId(12),
                       point,
                       end,
                       length(0.03),
                       {std::string{"Overall distance"},
      ...
      sketch::Snell{constraintId(23),
                    {firstLine, sketch::PointKey::Start},
                    {secondLine, sketch::PointKey::End},
                    rectangleLines[0],
                    dimensionless(1.5)},
  };
  return result;
