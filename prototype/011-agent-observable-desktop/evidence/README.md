...
The Qt accessibility plus registered-`QQuickWindow` path is viable for the tested Linux/X11 client surfaces. It does not close TECH-011: Wayland, Windows, native transients, mixed DPI, overlap/z-order, GPU/device loss, semantic actions, packaging, and app-server image attachment remain unproved.
