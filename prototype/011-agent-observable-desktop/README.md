# TECH-011 — Agent-Observable Desktop
...
```sh
cmake -S prototype/011-agent-observable-desktop -B build-prototype-011 -G Ninja
cmake --build build-prototype-011
xvfb-run -a -s '-screen 0 1600x900x24' \
  build-prototype-011/kearne-observation-prototype --output /tmp/kearne-observation
```
